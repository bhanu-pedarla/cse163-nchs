...
![regplot](./images/bestfit_simple_reg.png)
...
[Seaborn Tutorial](https://seaborn.pydata.org/tutorial/regression.html)    
[Seaborn regplot API](http://seaborn.pydata.org/generated/seaborn.regplot.html)    
...
![regplot](./images/bestfit_linregress.png)
...
![regplot](./images/bestfit_polyfit.png)
...
:::{tab-item} Correlation plot

![numpy-correlation](./images/numpy-correlation.png)
...
wave data, you'll more likely want to leverage [Fourier Transforms.](https://youtu.be/spUNpyF58BY) The
...
![regplot](./images/bestfit_curve_two.png)
...
![regplot](./images/bestfit_curve_fit.png)
...
Confusing? See the video, [Gradient descent, how nerual
networks learn](https://youtu.be/IHZwWFHWa-w?t=567), by 3Blue1Brown, to get a great visual on Gradient Descent. This video is tailored
