---
title: Line Plots
short_title: Line Plots
---

# Line Plots

Line Plots are likely the most common plot you'll create in IDP. It is fantastic for 
[showing correlations](geospatial.html#correlations-and-coefficient-of-determination). While line plots are not complicated, it can be frustrating
...
![Temperature Data](./images/line_data.png)
...
![Default Plot](./images/line_default_df_plot.png)  
```python
...
![Temperature Data](./images/line_min_max_temps.png)  
```python
...
![Subplots](./images/line_subplots.png)  
```python
...
![Default Plot](./images/line_temps_for_2021.png)  
...
![Temperature Data](./images/line_hours_of_daylight.png)  
...
![custom Line](./images/line_custom_line.png)  
...
![Bad Precipitation](./images/line_rain_temps.png)  
...
[TimeSeries.](https://cse163.github.io/book/module-3-pandas/lesson-9-time-series/time-series.html)
...
![Good Precipitation](./images/line_rain_temps_fixed.png)  
...
![Temperature & Daylight](./images/line_temp_daylight.png)
...
![Pivot Data](./images/annotation_data.jpg)  
...
![Unpivoted Data](./images/line_unpivoted_data.png)  
