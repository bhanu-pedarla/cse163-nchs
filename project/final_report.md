...
3) to validate that you met your Challenge Goals (_Reminder:_ we agreed challenge goal code should the students own work)
...
* **Results** : This the bulk of your report where you will display your plots. Label the figures so that when your text references them it is clear which plot is being referenced. This section must be 100% **data driven** and devoid of all speculation. Students are to briefly explain and describe what the data says. Do not explain _why_ the data is that way, only _that_ the data _is_ that way. Any subjective opinion or speculation must be put into the _Discussion_ section. All qualitative comments made about the data must be cited.More details below. This section can optionally have subsections as appropriate, such as:
    ...
    * **ML Model** : _If this was part of your challenge goals._ Explore the results of your Machine Learning model. Provide transparency into how the model makes decisions by graphing the decision space. Provide useful predictions, explore biases, potential for a feedback loop, and/or do a fairness analysis (Accuracy, Predictive Equality, Statistical Parity, Equal Opportunity). Explain with examples where your model predicts well and where it predicts poorly (reference your confusion matrix).
* **Discussion** : This is a section where you can make speculations about your data. The sky is the limit here. Go where your heart desires. Why do you think certain things are they way the data suggests? Or, why do you think the data is a poor representation of reality? Speculate away!
...
* **Challenge Goals** : This is a VERY IMPORTANT section for your grade. List your challenge goals and expand on how they worked out. You'll be graded primarily on the sum total of the difficulty of your work for your challenges. Each challenge goal should be around 1 page of content.   
* **References** : List all the sources cited in the paper; including our lecture website material; I would expect no fewer than 10 sources for most projects.

## Results Section

The goal of Data Science is to be [Data Driven](https://uta.pressbooks.pub/datanotebook/chapter/1-2-data-driven-research/). Refrain from subjective opinions which are typically based on personal beliefs, preferences, or anecdotal evidence (Keep that for the Discussion section). If you want to conclude that one thing might be due to another you must present data to illustrate the correlation. Alternatively, you can provide a citation to a book, article or research paper that supports your position. <a href="#footnotes"><sup>[1]</sup></a> <a href="#footnotes"><sup>[2]</sup></a>

Let the data speak for itself.  

Work hard to create plots that speak volumes! Simplifying your plots often speaks the loudest. Be sure to use techniques such as zooming into relevant sections or highlighting interesting data elements. Review our lectures and follow our guidelines for Data Visualization.
